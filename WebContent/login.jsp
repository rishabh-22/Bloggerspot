...
<div class="login-page">
	<div class="form">
		<form name="myForm" class="login-form" action = "loginRegister" method = "post">
			<input type="text" placeholder="username" name = "username">
			<input type="password" placeholder="password" name = "password">
			<input style="background:green" type="submit" name="submit" value="login" onClick = "return validate()" >
